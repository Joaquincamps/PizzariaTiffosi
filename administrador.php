...
<body>
    ...
    <abbr title="Volver a inicio"><a href="index.php"><img src="img/logo.png" alt="Logo web" id="logo"></a></abbr>
        <nav>
            <ul>
                <a href="administrador.php" id="active"><i class="fa-solid fa-house"></i>Administrador</a>
    ...
    <table>
            ...
            <th colspan=2></th>
                    ...
                    try {
                        ...
                        $sentenciaSelect = "SELECT id,nombre,rol, contraseña, correo, direccion FROM personas";
                        $resultado = $conexion->query($sentenciaSelect);
                    

                        while ($fila = $resultado->fetchObject()) {
                            // TABLA DE CLIENTES
                            echo "<tr> <td>".$fila->id. "</td> <td>".$fila->nombre."</td> <td >".$fila->rol."</td> <td>**********</td> <td>".$fila->correo."</td> <td>".$fila->direccion."</td> <td>";
                        ?>
                            <div id='botones'>
                        ...
                        <tr>
                            ...
                            <td><input type="text" placeholder="contraseña" name="contraseña" id='contraseña'></td>
                            <td><input type="text" placeholder="correo" name="correo" id='correo'></td>
                            <td><input type="text" placeholder="direccion" name="direccion" id='direccion'></td>
